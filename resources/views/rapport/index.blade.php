        ...
        <div class="row">
            <div class="col col-md-12">
                ...
                <div class="nav nav-fill my-3">
                    <label class="nav-link shadow-sm step0 border ml-2">Infomation des activités</label>
                ...
                <form method="POST" action="{{route('StorRapport')}}" id="employee-form" class="employee-form">
                    @csrf
                        ...
                        <div class="form-section "  id="show-item">
                            <label for="nomActivite" class="form-label">Nom d'activité</label>
                            <input type="text" name="nomActivite[0]" id="nomActivite" placeholder="Intitulé..." />
                            ...
                            <textarea name="descriptionActivite[0]" id="descriptionActivite" placeholder="..." ></textarea>
                            
                      
                            <label for="dateDebutActivite" class="form-label">Date début</label>
                            <input type="date" name="dateDebutActivite[0]" id="dateDebutActivite"  />
                        
                            <label for="dateFinActivite" class="form-label">Date fin</label>
                            <input type="date" name="dateFinActivite[0]" id="dateFinActivite"  />
                        ...
                        <div class="form-section" id="contraints_div">
                            <label for="ActiviteContraint" class="form-label">Choisir l'activité</label>
                            <select name="ActiviteContraint[0]" id="typeActivite" >
                                <option value=""></option>
                                <option value=""></option>
                                <option value=""></option>
                            </select>
                            ...
                            <input type="text" name="typeContraint[0]" id="typeContraint" placeholder="Type..." />
           
                            <label for="SujetC" class="form-label">Sujet de contraints</label>
                            <input type="text" name="SujetC[0]" id="SujetC" placeholder="Sujet..." />
                            <label for="descriptionContraint" class="form-label">Déscription</label>
                            <textarea name="descriptionContraint[0]" id="descriptionContraint" placeholder="..."></textarea>
